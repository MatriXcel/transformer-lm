...
from transformer_lm.modeling_transformer import TransformerEncoder, TransformerLM
import wandb
...
def main():
    ...
    # YOUR CODE STARTS HERE
    model = TransformerLM(args.num_layers, args.hidden_size, args.num_heads, args.fcn_hidden, tokenizer.vocab_size, args.max_seq_length, args.dropout)
    # YOUR CODE ENDS HERE
